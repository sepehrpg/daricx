package com.example.network.global.mappers
...
class GlobalMapperTest {
    ...
    @Test
    fun `maps populated dto to domain`() {
        ...
        Truth.assertThat(domain.activeCryptocurrencies).isEqualTo(12045)
        Truth.assertThat(domain.marketCapChangePercentage24hUsd).isWithin(0.001).of(-0.56)
        Truth.assertThat(domain.totalMarketCap?.get("usd")).isWithin(0.001).of(2_350_000_000_000.0)
        Truth.assertThat(domain.marketCapPercentage?.get("btc")).isWithin(0.0001).of(52.1)
        Truth.assertThat(domain.updatedAt).isEqualTo(1_725_148_800L)
    }
