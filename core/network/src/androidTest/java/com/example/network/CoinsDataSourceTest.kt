...
/**
 * An instrumentation test class for [CoinsDataSource].
...
class CoinsDataSourceTest {
    ...
    /**
     * Injects an instance of [CoinsDataSource] provided by Hilt.
    ...
    fun getCoinMarketsList_showDataInLog_returnsNonEmptyList() = runTest {
        try {
            ...
            val result = remoteDataSource.getCoinMarkets("usd", page = 1, perPage = 50, sparkline = false)
