...
class ExchangesDataSourceTest {
    ...
    @Test
    fun getExchangeById_showDataInLog_returnsNonEmptyList() = runTest {
        try {
            // Arrange & Act: Call the function from the data source.
            val result = remoteDataSource.getExchangeById(id = "binance", null)
            ...
            // Assert: Verify that the result is not empty, confirming a successful fetch.
            //TestCase.assertTrue("The returned list should not be empty", true)
